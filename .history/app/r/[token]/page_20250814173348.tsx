...
export default function RegisterPage({ params }: { params: unknown }) {
  ...
  useEffect(() => {
    if (!isMobile) {
      ...
      return;
        ...
        // Fix: unwrap params if it is a Promise (should not happen, but defensive)
          ...
          if (typeof params === 'object' && typeof (params as Promise<any>).then === 'function') {
            ...
            (params as Promise<{ token: string }> ).then((p) => {
              ...
              if (process.env.NODE_ENV === 'development') {
                ...
                console.warn('params was a Promise, unwrapped at runtime. Fix your route usage.');
              }
            });
          } else {
