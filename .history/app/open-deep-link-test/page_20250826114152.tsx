...
export default function OpenDeepLinkPage({ params }: PageProps) {
  return <OpenDeepLinkClientPromise params={params} />;
}

function OpenDeepLinkClientPromise({ params }: { params: Promise<{ key: string }> }) {
